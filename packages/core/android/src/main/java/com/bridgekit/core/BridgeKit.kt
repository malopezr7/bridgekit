...
class BridgeKit internal constructor(
    ...
    companion object {
        ...
        /** Tracing flag — mirrors [com.bridgekit.diagnostics.BridgeKitDiagnostics.devTracing]. */
        var devTracing: Boolean
            get() = com.bridgekit.diagnostics.BridgeKitDiagnostics.devTracing
            set(value) { com.bridgekit.diagnostics.BridgeKitDiagnostics.devTracing = value }
    }
...
private class LazyInboundAdapter(
    ...
    private val adapter: com.bridgekit.runtime.InboundContractAdapter by lazy {
