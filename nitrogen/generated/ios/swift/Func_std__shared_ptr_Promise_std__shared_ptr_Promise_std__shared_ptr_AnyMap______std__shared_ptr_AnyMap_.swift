...
public final class Func_std__shared_ptr_Promise_std__shared_ptr_Promise_std__shared_ptr_AnyMap______std__shared_ptr_AnyMap_ {
  ...
  public init(_ closure: @escaping (_ env: AnyMap) -> Promise<Promise<AnyMap>>) {
    self.closure = closure
  }

  @inline(__always)
  public func call(env: margelo.nitro.SharedAnyMap) -> bridge.std__shared_ptr_Promise_std__shared_ptr_Promise_std__shared_ptr_AnyMap_____ {
    let __result: Promise<Promise<AnyMap>> = self.closure(AnyMap(withCppPart: env))
