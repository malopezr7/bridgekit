...
// Exact copy of apps/example/ios/BridgeKitExample/bridgekit/BridgekitDemoInitializer.swift.
// The initializer must be called before the JS bundle loads so that native
// providers are registered in BridgeKitRuntime before JS consumers try to
// resolve them.  AppDelegate.swift calls BridgekitDemoInitializer.configure()
// before presenting any view controller that hosts a React Native root view.
