...
object BridgekitDemoHostContract : BridgeContractDefinition<BridgekitDemoHost, BridgekitDemoHostClient>(
    ...
    memberHashes = mapOf(
        "methods.ping" to "a65e4d35",
        "methods.increment" to "6c6f31cf",
        "methods.say" to "0432c111",
        "streams.ticker" to "4725c2c3",
        "streams.echoes" to "45c6b5cb",
        "state.counter" to "83f1adea"
    )
) {
