...
// ---------------------------------------------------------------------------
// BridgekitDemoInitializer — verbatim copy of
...
public enum BridgekitDemoInitializer {
  /// Register all native BridgeKit providers.
  /// Call BEFORE ReactNativeBrownfield.shared.startReactNative(...)
